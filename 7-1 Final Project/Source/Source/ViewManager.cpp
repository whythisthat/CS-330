...
namespace
{
	...
	// flag for perspective and orthographic projection
 ...
 *
 *  This method is automatically called from GLFW whenever
 *  the mouse scroll wheel is moved within the active window.
 ***********************************************************/
void ViewManager::Scroll_Callback(GLFWwindow* window, double xOffset, double yOffset)
{
	// adjust the camera's speed based on the scroll wheel movement
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process camera movement up and down with Q and E keys
...
void ViewManager::PrepareSceneView()
{
	...
	else
	{
		...
		g_pCamera->Position = glm::vec3(0.0f, 0.0f, 10.0f);  // Reset camera to look directly at the object
		g_pCamera->Front = glm::vec3(0.0f, 0.0f, -1.0f);     // Look directly at the object
	}
